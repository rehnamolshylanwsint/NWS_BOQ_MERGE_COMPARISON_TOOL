...
if st.session_state["page"] == "welcome":
    ...
    if not st.session_state["visited"]:
        st.markdown("<h1 class='main-title'>🌟 Welcome to NWS International</h1>", unsafe_allow_html=True)
        st.markdown("<h3 class='subtitle'>AI-Powered Tender BoQ Merge & Comparison Tool</h3>", unsafe_allow_html=True)
        ...
        with st.container():
            st.markdown(
                ...
                Upload contractor BoQs, merge them, compare <b>RATES & AMOUNTS</b>,<br>
        ...
        st.markdown("<h3 class='subtitle'>Good to see you again! Ready to continue?</h3>", unsafe_allow_html=True)
    ...
    if uploaded_files and st.button("🔗 Merge & Compare"):
        ...
        for sheet_name in wb.sheetnames:
            ...
            for r in range(header_excel_row + 1, ws.max_row + 1):
                ...
                for (rate_col, amt_col, eff_val, rate_valid) in contractor_data:
                    ...
                    # Missing or invalid -> spread yellow
                    if eff_val is None:
        ...
        st.markdown(
            ...
            <div style="background:white;padding:15px;border-radius:10px;
                ...
                <h4 style="margin:0 0 10px 0;color:#1E3D59;">🔑 Legend</h4>
                <p style="margin:4px 0;">🟩 <b>Green</b> = Lowest Rate/Amount</p>
                <p style="margin:4px 0;">🟥 <b>Red</b> = Highest Rate/Amount</p>
                <p style="margin:4px 0;">🟨 <b>Yellow</b> = Missing or Invalid Value</p>
            </div>
            """,
            unsafe_allow_html=True
        )
        ...
        for sheet, df in merged_book.items():
            ...
            # Fix ArrowTypeError by converting to string
            st.dataframe(df.head(50).astype(str), width="stretch")
